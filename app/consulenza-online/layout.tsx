...
export const metadata: Metadata = {
  ...
  description:
    "Consulenza professionale online per pizzaioli e pizzerie. Sessioni da 3 giorni × 3 ore a 250€. Attestato di merito incluso. Sconto 10% su più pacchetti.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Sessioni di consulenza live online per pizzaioli. 3 giorni × 3 ore a 250€, attestato di merito incluso. Sconto 10% su più pacchetti.",
