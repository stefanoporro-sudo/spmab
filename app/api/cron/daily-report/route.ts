  ...
  <div style="max-width:560px;margin:32px auto;background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.08);">
    ...
    <div style="padding:24px 32px 32px;display:flex;gap:12px;flex-wrap:wrap;">
      <a href="https://www.consulenzapizzaiolo.it/admin"
         style="flex:1;min-width:160px;display:block;text-align:center;background:#d47e28;color:#fff;text-decoration:none;padding:14px 20px;border-radius:8px;font-weight:bold;font-size:14px;">
        📊 Vedi Statistiche →
      </a>
      <a href="https://www.consulenzapizzaiolo.it/admin"
         style="flex:1;min-width:160px;display:block;text-align:center;background:#333;color:#fff;text-decoration:none;padding:14px 20px;border-radius:8px;font-weight:bold;font-size:14px;">
        ⚙️ Pannello Admin →
      </a>
    </div>
