...
11. **Grani antichi e macinazione a pietra** (categoria app: Panificazione): farro monococco e diccocco, Senatore Cappelli, Timilia, Russello, Perciasacchi, Verna, Saragolla — storia e caratteristiche; differenza tra farina industriale e macinata a pietra; perché Bonci e i grandi artigiani scelgono i grani antichi; dove trovarli e come usarli nell'impasto
12. **Pizza in teglia romana** (categoria app: Pizza): idratazione 75–85%, come stendere senza mattarello, riposo in teglia di ferro blu, pressatura con le dita, cottura in due fasi, differenze tecniche e di gusto rispetto alla pizza napoletana e alla pizza al piatto — lo stile che ha reso famoso Bonci nel mondo
13. **Lievito madre: dalla creazione alla gestione** (categoria app: Panificazione): come creare un lievito madre da zero, rinfreschi e cadenze, conservazione in frigo vs a temperatura ambiente, licoli (lievito madre liquido), come capire se è maturo, errori comuni, differenza tra lievito madre e lievito di birra in termini di sapore e struttura dell'impasto
14. **Fermentazione a freddo** (categoria app: Pizza): come e perché usare il frigorifero nell'impasto, temperature ideali (4–6°C), tempi da 24 a 72 ore, effetti sul profilo aromatico e sulla struttura della maglia glutinica, come organizzare la produzione in pizzeria con il freddo
15. **Stagionalità in pizzeria e panificio** (categoria app: Generale): come cambiare il menu seguendo le stagioni, ingredienti estivi vs invernali, perché la stagionalità migliora sia il gusto che il food cost, esempi pratici di pizze e prodotti da forno stagionali, rapporto con i fornitori locali
16. **Filiera corta e sostenibilità** (categoria app: Business): chilometro zero applicato alla pizzeria, come scegliere fornitori locali di farine, pomodoro, latticini, riduzione degli sprechi in impasto e farcitura, packaging sostenibile, perché la sostenibilità è anche marketing e fidelizzazione
17. **Cottura: padroneggiare il forno** (categoria app: Generale): differenze tra forno a legna, elettrico e a gas, pietre refrattarie vs acciaio vs teglie di ferro, temperature per stili diversi (napoletana, teglia, pala), come leggere la cottura dal cornicione e dalla base, errori di cottura più comuni e come correggerli
18. **Gestione delle intolleranze in pizzeria** (categoria app: Consulenza): come servire clienti celiaci (protocollo anti-contaminazione), sensibilità al glutine non celiaca, intolleranza al lattosio, clienti vegani — come trasformare i vincoli in opportunità di menù senza snaturare il prodotto
19. **Social media per pizzaioli e panificatori** (categoria app: Business): come fotografare pizza e pane con lo smartphone, luce naturale vs artificiale, angolazioni che funzionano, che contenuti pubblicare su Instagram e TikTok, storie vs reel, come costruire una comunità autentica senza trucchi — con esempi da profili artigiani che funzionano davvero
20. **Diventare pizzaiolo: verità e trappole** (categoria app: Consulenza): come si diventa davvero pizzaiolo (esperienza vs corsi), le trappole dei corsi da migliaia di euro che promettono troppo, il valore dello stage in una pizzeria vera, percorsi realistici per chi parte da zero o vuole cambiare lavoro, cosa cercano davvero i titolari quando assumono
21. **Abbinamenti pizza e bevande** (categoria app: Pizza): pizza e birra artigianale (stili e abbinamenti per tipo di pizza), pizza e vino (quando funziona e quando no), acqua frizzante vs naturale a tavola, perché l'abbinamento giusto valorizza anche un impasto semplice — consigli pratici per la carta beverages in pizzeria
22. **Il pizzaiolo freelance e le consulenze** (categoria app: Consulenza): come lavorare come consulente pizzaiolo, pop-up e cene private, corsi in pizzeria, affiancamento ai titolari, come costruire un'offerta professionale partendo dalla propria esperienza, tariffe e contratti — il percorso di Stefano come esempio concreto
