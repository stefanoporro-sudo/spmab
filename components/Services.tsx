  ...
  return (
    <section id="servizi" className="py-28 bg-dark-900">
      <div className="max-w-7xl mx-auto px-6">
        ...
        {/* ── Richiamo Eventi & Personal Chef ─────────────────────── */}
        <a
          href="/eventi-personal-chef"
          className="mt-16 flex items-center justify-between gap-4 rounded-2xl border border-dark-600 bg-dark-800 hover:border-brand-500/40 hover:bg-dark-800/70 transition-all duration-300 px-6 py-5 group"
        >
          <div className="flex items-center gap-4">
            <div className="p-3 rounded-xl bg-brand-500/15 shrink-0">
              <UtensilsCrossed className="text-brand-400 w-5 h-5" />
            </div>
            <div>
              <div className="text-white font-semibold text-sm">Organizzi un evento privato?</div>
              <div className="text-gray-500 text-sm">Scopri il servizio Personal Chef Pizzaiolo a domicilio</div>
            </div>
          </div>
          <ArrowRight size={18} className="text-gray-500 group-hover:text-brand-400 group-hover:translate-x-1 transition-all duration-300 shrink-0" />
        </a>
