...
⚠️ **Anche i 300 argomenti possono nascondere ripetizioni tematiche sotto voci diverse** (verificato: "idratazione" era duplicata sotto 6 voci diverse in categorie diverse, es. tecnica/panificazione/storia — tecnicamente distinte come testo quindi mai bloccate dalla rotazione, ma percepite come la stessa cosa). Se un tema torna a sembrare ripetitivo, il primo sospetto è una duplicazione nascosta in `TOPICS`, non un bug della rotazione — cercare per parola chiave nel file prima di aggiungere altri controlli.
